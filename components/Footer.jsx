  ...
  return (
    <footer className="bg-blue-1 mt-28 relative flex justify-center">
      <Image
        ...
        priority={false}
        quality={100}
        className="absolute w-2/3 opacity-30"
      />
      <div className="container flex flex-col lg:gap-0 gap-10 lg:flex-row pt-10 pb-40">
        ...
        <div className="lg:w-1/2 flex flex-col gap-10 lg:gap-36">
          <div className="flex flex-col lg:flex-row lg:gap-0 gap-10">
            <div className="flex flex-col grow gap-3">
              ...
              <p className="font-normal text-base text-white">Data Science</p>
            </div>
            <div className="flex flex-col grow gap-3">
              ...
              <p className="font-normal text-base text-white">Bootcamp Tokyo</p>
              <p className="font-normal text-base text-white">Bootcamp Seoul</p>
            </div>
            <div className="flex flex-col grow gap-3">
