      ...
      <div className="flex flex-col gap-14">
        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-row text-white font-medium">
            ...
            <p className="relative z-0 py-2 bg-[#FFEACC] text-black text-xl rounded-r-full w-96 px-4 pl-14 flex items-center -translate-x-10">
          ...
          <div className="flex flex-row text-white font-medium">
            ...
            <p className="relative z-0 py-2 bg-[#DDF2FF] text-black text-xl rounded-r-full w-96 px-4 pl-14 flex items-center -translate-x-10">
          ...
          <div className="flex flex-row text-white font-medium">
            ...
            <p className="relative z-0 py-2 bg-orange-1 text-black text-xl rounded-r-full w-96 px-4 pl-14 flex items-center -translate-x-10">
